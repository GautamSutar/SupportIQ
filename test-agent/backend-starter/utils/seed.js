...
dotenv.config();
require('dns').setServers(['8.8.8.8', '1.1.1.1', ...require('dns').getServers()]);
...
const conversations = [
  ...
  },
  {
    ...
    messages: [
      {
        sender: "customer",
        text: "My order arrived a day early, just wanted to say thanks!",
        timestamp: new Date(Date.now() - 90 * 60000)
      },
      {
        sender: "agent",
        text: "That's wonderful to hear! Thank you for letting us know, and thanks for shopping with RetailPlus.",
        timestamp: new Date(Date.now() - 89 * 60000)
      }
    ],
    tags: ["compliment"],
  ...
  },
  {
    ...
    messages: [
      {
        sender: "customer",
        text: "This is the third time I'm contacting you about my broken security system. I want a refund, not another troubleshooting script.",
        timestamp: new Date(Date.now() - 40 * 60000)
      },
      {
        sender: "agent",
        text: "I understand your frustration. Let me look into your account history.",
        timestamp: new Date(Date.now() - 38 * 60000)
      }
    ],
    tags: ["escalation", "refund-request", "repeat-contact"],
    humanIntervention: { occurred: false }
  },
  {
    id: "conv-2023-48",
    ...
    messages: [
      {
        sender: "customer",
        text: "Do I need the original box to return the blender?",
        timestamp: new Date(Date.now() - 5 * 60000)
      }
    ],
    tags: ["returns"],
...
const templates = [
  {
    ...
    category: "Onboarding",
    content: "Hi {{customer_name}}! Welcome to {{company_name}}. How may I be of help today?",
    variables: [
  ...
  },
  {
    ...
    category: "Onboarding",
    content: "Hi {{customer_name}}, I noticed you're browsing {{product_category}}. Would you like a hand finding what you need?",
    variables: [
      { name: "customer_name", description: "Customer's first name" },
      { name: "product_category", description: "Category being browsed" }
    ],
    createdBy: "supervisor",
    isShared: true
  },
  {
    ...
    category: "Onboarding",
    content: "Welcome aboard, {{customer_name}}! Want a quick tour of your account dashboard and order tracking?",
    variables: [{ name: "customer_name", description: "Customer's first name" }],
    createdBy: "supervisor",
    isShared: false
  },
  {
    id: "tmpl-personalized",
    name: "Learn about personalized experiences.",
    category: "Engagement",
    content: "Hi {{customer_name}}, based on your past orders we think you'd like our {{recommended_product}}. Want details?",
    variables: [
      { name: "customer_name", description: "Customer's first name" },
      { name: "recommended_product", description: "Recommended product name" }
    ],
    createdBy: "supervisor",
    isShared: false
  },
  {
    ...
    category: "Engagement",
    content: "Hi {{customer_name}}, have you tried our new {{feature_name}} feature yet? I can walk you through it.",
    variables: [
      { name: "customer_name", description: "Customer's first name" },
      { name: "feature_name", description: "Feature being highlighted" }
    ],
    createdBy: "supervisor",
    isShared: true
  },
  {
    id: "tmpl-return-eligibility",
    name: "Confirm return eligibility.",
    category: "Return",
    content: "Hi {{customer_name}}, your order #{{order_id}} is eligible for return until {{return_deadline}}.",
    variables: [
      { name: "customer_name", description: "Customer's first name" },
      { name: "order_id", description: "Order number" },
      { name: "return_deadline", description: "Return window deadline" }
    ],
    createdBy: "supervisor",
    isShared: true
  },
  {
    id: "tmpl-refund-status",
    name: "Share refund status update.",
    category: "Transaction",
    content: "Hi {{customer_name}}, your refund of {{refund_amount}} for order #{{order_id}} has been processed.",
    variables: [
      { name: "customer_name", description: "Customer's first name" },
      { name: "refund_amount", description: "Refund amount" },
      { name: "order_id", description: "Order number" }
    ],
    createdBy: "supervisor",
    isShared: true
